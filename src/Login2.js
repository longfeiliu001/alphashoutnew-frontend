// Login2.js - Professional authentication system with AlphaShout branding
...
export const AuthProvider = ({ children }) => {
  ...
  const register = async (email, password) => {
    ...
    if (data.user && data.quota !== undefined) {
      setUser(data.user);
      sessionStorage.setItem('auth_user', JSON.stringify(data.user));
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Simplified Security Information */}
        <div style={{
          marginTop: '24px',
          padding: '16px',
          backgroundColor: AlphaShoutTheme.colors.background,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={AlphaShoutTheme.colors.success} strokeWidth="2">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                </svg>
                <span>Secure</span>
              </div>
            ...
            <div>
              <a href="#" style={{ color: AlphaShoutTheme.colors.primary, textDecoration: 'none', marginRight: '12px' }}>Terms</a>
              <a href="#" style={{ color: AlphaShoutTheme.colors.primary, textDecoration: 'none' }}>Privacy</a>
            </div>
          </div>
        </div>
      </div>
